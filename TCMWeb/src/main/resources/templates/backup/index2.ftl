...
<!--[if (gte IE 9)|!(IE)]><!-->
<script type="text/javascript" src="site-template/lib/jquery/jquery.min.js"></script>
<!--<![endif]-->
<!--[if lte IE 8 ]>
<script src="http://libs.baidu.com/jquery/1.11.3/jquery.min.js"></script>
<script src="http://cdn.staticfile.org/modernizr/2.8.3/modernizr.js"></script>
<script src="site-template/lib/amazeui/amazeui.ie8polyfill.min.js"></script>
<![endif]-->
<script type="text/javascript" src="site-template/lib/handlebars/handlebars.min.js"></script>
<script type="text/javascript" src="site-template/lib/iscroll/iscroll-probe.js"></script>
<script type="text/javascript" src="site-template/lib/amazeui/amazeui.min.js"></script>
<script type="text/javascript" src="site-template/lib/raty/jquery.raty.js"></script>
<script type="text/javascript" src="site-template/js/main.min.js?t=1"></script>
</head>
<body>
    ﻿<header class="hd">
    ...
    <div class="cg">
        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            ...
            <h3>@2015-2016 版权所有 大冶云阿拉丁科技有限公司 粤ICP备12071064号-2 </h3>
        </div>
    </div>
</footer>
