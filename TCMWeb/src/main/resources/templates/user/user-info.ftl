						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" id="username"
									name="username" placeholder="用户名" value="${Session["user"]["account"]}">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" id="mobile"
									name="mobile" placeholder="手机" value="${Session["user"]["mobile"]}">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" id="email" name="email"
									placeholder="邮箱" value="${Session["user"]["email"]}">
							</div>
						</div>

						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<button id="btn-update" class="btn btn-primary">修改信息</button>
							</div>
						</div>
					</div>
				</div>
