...
<!--         <p>To see the difference between static and fixed top navbars, just scroll.</p> -->      
		 ...
		 <div class="row search-box">
		  <div class="col-lg-10">
		    <div class="input-group">
		      <input type="text" class="form-control" name="keywords" placeholder="请输入疾病名称或概要" id="input-keyword" value="${keyword}">
    ...
    <script src="/js/packages/require.js" data-main="/js/diseases-search"></script>
