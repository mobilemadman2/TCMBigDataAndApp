...
<body>
<style> 
.v {border-collapse: seperate;text-align:left;} 
.v td{ border: none; border-bottom: dashed 1px #ddd; padding:5px;} 
	...
	<div class="container">
		...
		<div id="targetname" class="col-xs-16" style="color:#708090; width:100%">病证名称：</div></td><td><div class="col-xs-16"><#if (syndrome.name!"") !="">${syndrome.name}
				...
				<td> 
					...
					<div class="col-xs-16" style="color:#708090; width:100%">证名编号：</div></td><td><div class="col-xs-16" style="width:100%"><#if (syndrome.standard_num!"") !="">${syndrome.standard_num} </#if></div>
		...
		<tr>
		<td> 
					<div class="col-xs-16" style="color:#708090; width:100%">英文名称：</div></td><td><div class="col-xs-16" style="width:100%"><#if (syndrome.name_en!"") !="">${syndrome.name_en}</#if></div>
				
				<!-- /.blog-post --> </td>
		<td> 
					<div class="col-xs-16" style="color:#708090; width:100%">一级分类：</div></td><td><div class="col-xs-16" style="width:100%"><#if (syndrome.level1_name!"") !="">${syndrome.level1_name}</#if></div>
        ...
        <tr>
		<td> 
				<div class="col-xs-16" style="color:#708090; width:100%">二级分类：</div></td><td><div class="col-xs-16" style="width:100%"> <#if (syndrome.level2_name!"") !="">${syndrome.level2_name}</#if></div>
				<!-- /.blog-post --> </td>
        </tr>
