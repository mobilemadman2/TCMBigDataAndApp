...
<!-- 		</div>/.row -->
					...
					<div class = "search-all">
						...
						<table id="table" class="table">
						  <thead>
						    <tr>
						      <!-- <th></th> -->
						      <th class='surgery-data-table show_column-1'>病人ID</th>
						      <th class='surgery-data-table show_column-2'>手术名称</th>
						      <th class='surgery-data-table show_column-3'>更新时间</th>
						      <th class='surgery-data-table show_column-4'>操作</th>
						    </tr>
						  </thead>
						  <tbody id="table-all">
						  </tbody>
    ...
    <script src="/js/packages/require.js" data-main="/js/surgery"></script>
