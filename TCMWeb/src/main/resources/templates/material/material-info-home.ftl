...
<body>
	...
	<div class="container">
		<div class="blog-header">
			<h1 class="blog-title">${material.id}（编号）</h1>
...
<#if (material.link!"") !="">
				...
				<!-- /.blog-post --> </#if><#if (material.nameCn!"") !="">
				<div class="blog-post" id="id-overview">
				...
				<!-- /.blog-post --> </#if><#if (material.pinyin!"") !="">
				<div class="blog-post" id="id-overview">
				...
				<!-- /.blog-post --> </#if><#if (material.picture!"") !="">
				<div class="blog-post" id="id-overview">
				...
				<!-- /.blog-post --> </#if><#if (material.sourceCn!"") !="">
				<div class="blog-post" id="id-overview">
				...
				<!-- /.blog-post --> </#if><#if (material.sourceEn!"") !="">
				<div class="blog-post" id="id-overview">
				...
				<!-- /.blog-post --> </#if><#if (material.description!"") !="">
				<div class="blog-post" id="id-overview">
