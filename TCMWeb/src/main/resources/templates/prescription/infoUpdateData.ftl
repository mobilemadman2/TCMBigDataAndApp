...
<div class="container">
	...
	<!-- <p>新增方剂</p>-->
	<form name="frmLogin" id="frmLogin" action="/prescription/infoUpdateData">
	<div class="blog-post" id="id-name">
		<h2 class="blog-post-title">方名</h2>
		<blockquote>
			<textarea style="width:600px;height:100px;" name="name" id="name">${prescription.name}</textarea><br>
		</blockquote>
	</div>
	<div class="blog-post" id="id-alias">
		<h2 class="blog-post-title">别名</h2>
		<blockquote>
			<textarea style="width:600px;height:100px;resize:none;" name="alias" id="alias">${prescription.alias}</textarea><br>
		</blockquote>
	</div>			
	<div class="blog-post" id="id-composition">
		<h2 class="blog-post-title">处方</h2>
		<blockquote>
			 <textarea style="width:600px;height:100px;" name="composition" id="composition">${prescription.composition}</textarea><br> 
		</blockquote>
	</div>
	<div class="blog-post" id="id-processed">
		<h2 class="blog-post-title">炮制</h2>
		<blockquote>
			<textarea style="width:600px;height:100px;" name="processed" id="processed">${prescription.processed}</textarea><br> 
		</blockquote>
	</div>
	<div class="blog-post" id="id-process">
		<h2 class="blog-post-title">制法</h2>
		<blockquote>
			<textarea style="width:600px;height:100px;" name="process" id="process">${prescription.process}</textarea><br> 
		</blockquote>
	</div>
	<div class="blog-post" id="id-pharmacologicaleffects">
		<h2 class="blog-post-title">药理作用</h2>
		<blockquote>
			<textarea style="width:600px;height:100px;" name="pharmacologicaleffects" id="pharmacologicaleffects">${prescription.pharmacologicaleffects}</textarea><br>  
		</blockquote>
	</div>
	<div class="blog-post" id="id-function">
		<h2 class="blog-post-title">功能主治</h2>
		<blockquote>
			<textarea style="width:600px;height:100px;" name="function" id="function">${prescription.function}</textarea><br>
		</blockquote>
	</div>
	<div class="blog-post" id="id-dosage">
		<h2 class="blog-post-title">用法用量</h2>
		<blockquote>
			<textarea style="width:600px;height:100px;" name="dosage" id="dosage">${prescription.dosage}</textarea><br> 
		</blockquote>
	</div>
	<div class="blog-post" id="id-remarks">
		<h2 class="blog-post-title">备注</h2>
		<blockquote>
			<textarea style="width:600px;height:100px;" name="remarks" id="remarks">${prescription.remarks}</textarea><br>
		</blockquote>
	</div>
	<div class="blog-post" id="id-variousDescription">
		<h2 class="blog-post-title">各家论述</h2>
		<blockquote>
			<textarea style="width:600px;height:100px;" name="variousDescription" id="variousDescription">${prescription.variousDescription}</textarea><br> 
		</blockquote>
	</div>	
	<div class="blog-post" id="id-application">
		<h2 class="blog-post-title">临床应用</h2>
		<blockquote>
			<textarea style="width:600px;height:100px;" name="application" id="application">${prescription.application}</textarea><br> 
		</blockquote>
	</div>	
	<div class="blog-post" id="id-attention">
		<h2 class="blog-post-title">注意</h2>
		<blockquote>
			<textarea style="width:600px;height:100px;" name="attention" id="attention">${prescription.attention}</textarea><br> 
		</blockquote>
	</div>	
	<div class="blog-post" id="id-source">
		<h2 class="blog-post-title">摘录</h2>
		<blockquote>
			<textarea style="width:600px;height:100px;" name="source" id="source">${prescription.source}</textarea><br>   
		</blockquote>
	</div>			
	<!--<textarea style="width:600px;height:100px;display:none" name="id" id="id" value=${prescription.id}>${prescription.id}</textarea>  	-->
	<textarea style="width:600px;height:100px;display:none" name="id" id="id">${prescription.id}</textarea>	
